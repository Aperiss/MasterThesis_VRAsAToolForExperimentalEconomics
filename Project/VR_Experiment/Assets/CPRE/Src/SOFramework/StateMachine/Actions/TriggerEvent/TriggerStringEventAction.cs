...
namespace CPRE.SOFramework.StateMachine.Actions.TriggerEvent {
    [CreateAssetMenu(fileName = "TriggerEventAction", menuName = "State Machine/Actions/Trigger Event/Trigger String Event", order = 0)]
    public class TriggerStringEventAction : Action {
        [SerializeField] private StringEventChannel eventChannel;
        [SerializeField] private StringReference eventParameter;
